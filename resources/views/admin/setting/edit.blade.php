...
@section('content')
	...
	<x-div class="mx-auto px-5 col-12">
		...
		<form method="POST" action="{{ route('admin.setting.update', $data->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
			@method('PATCH')
			@csrf
			<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-md-4">
					<input id="value" type="text" class="form-control @error('value') is-invalid @enderror" name="value" value="{{ old('value', $data->value) }}" required>
